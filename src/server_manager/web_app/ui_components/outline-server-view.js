      ...
      <iron-pages selected="{{selectedTab}}" attr-for-selected="name" hidden\$="{{!isServerReachable}}">
        <div name="connections">
          ...
          <div class="access-key-list card-section">
            <!-- header row -->
            <div class="access-key-row header-row" hidden$="[[!accessKeyRows.length]]">
            ...
            <div id="accessKeysContainer">
              ...
              <template is="dom-repeat" items="{{accessKeyRows}}" sort="{{_sortAccessKeys(accessKeySortBy, accessKeySortDirection)}}" observe="name transferredBytes">
