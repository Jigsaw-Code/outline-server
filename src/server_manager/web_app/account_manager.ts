...
//     k1.cloudProviderId === k2.cloudProviderId && k1.cloudSpecificId === k2.cloudSpecificId;
//
...
//   async connectDigitalOceanAccount(credentials: DigitalOceanCredentials):
//       Promise<DigitalOceanAccount> {
//     const persistedAccount = {
//       id: LEGACY_DIGITALOCEAN_ACCOUNT_ID,
//       credentials: credentials as unknown as object,
//     };
//     const account = await this.accountFactories
//         .get(CloudProviderId.DigitalOcean).constructAccount(persistedAccount);
//     this.add(account);
//     return account;
//   }
//
...
//   }
//
//   private register<T extends Account>(
//       cloudProviderId: CloudProviderId, factory: AccountFactory<T>) {
