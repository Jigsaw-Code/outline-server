...
export class App {
  ...
  private convertToUiAccessKey(remoteAccessKey: server_model.AccessKey): DisplayAccessKey {
    return {
      ...
      tgLogin: remoteAccessKey.tgLogin,
      tgFirst: remoteAccessKey.tgFirst,
      tgLast: remoteAccessKey.tgLast,
      createdAt: remoteAccessKey.createdAt,
      updatedAt: remoteAccessKey.updatedAt,
      paidBefore: remoteAccessKey.paidBefore,
