...
export interface CloudProviderService {
  ...
  createInstance(name: string, bundleId: string, locationId: string): Promise<GcpInstance>;
  deleteInstance(instanceId: string, locationId: string): Promise<void>;
  getInstance(instanceId: string, locationId: string): Promise<GcpInstance>;
  listInstances(locationId?: string): Promise<GcpInstance[]>;
  listLocations(): Promise<GcpLocation[]>;
}
...
export class GcpRestApiProviderService implements CloudProviderService {
  readonly cloudProvider = CloudProviderId.GCP;
  ...
  async getInstance(instanceId: string, locationId: string): Promise<GcpInstance> {
  ...
  // call.
  async listInstances(locationId?: string): Promise<GcpInstance[]> {
  ...
  async listLocations(): Promise<GcpLocation[]> {
  ...
  private static toInstance(instance: Instance, labels?: Map<string, string>): GcpInstance {
    return {
      id: instance.id,
      name: instance.name,
      location: {
